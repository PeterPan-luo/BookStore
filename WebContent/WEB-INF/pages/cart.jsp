...
<script type="text/javascript">
	...
	$(function(){
		...
		//ajax修改单个商品的数量
		//1. 获取页面的所有text，并为其添加onchange相应函数，弹出确认对话框，确认修改
...
<body>
		<center>
			<br><br>
			<div id="bookNumber">您的购物车中共有${sessionScope.ShoppingCar.bookNumber } 本书</div>
			<table cellpadding="10">
				...
				<tr>
					<td colspan="4" id="totalMoney">总金额: ￥${sessionScope.ShoppingCar.totalMoney }</td>
				</tr>
				<tr>
					<td colspan="4">
